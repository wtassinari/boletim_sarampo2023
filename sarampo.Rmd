...
### Distribuição da incidência acumulada (por 100 mil ha) dos casos de sarampo por Microrregiões, 2014-2020.

```{r, fig.align='center', fig.width=8, fig.height=7.5, cache=FALSE, echo=FALSE}
