---
title: "Alguns dados sobre a Vacinação"
---
...
banco0 <- read.csv('bases/cobvac_porregiao.csv',sep=';',dec=',')
...
```{r, fig.align='center', fig.width=12, fig.height=4.5, cache=FALSE, echo=FALSE}
...
```{r, fig.align='center', fig.width=12, fig.height=6, cache=FALSE, echo=FALSE}
g3 <- banco0 %>%
